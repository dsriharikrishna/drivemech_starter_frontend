...
} from "@/schemas/vehicleSearchSchema";
import { useRouter } from "next/navigation";
import { setCurrentVehicle, VehicleInfo } from "@/store/slices/cart/cartSlice";
...
export default function HeroSection() {
  ...
  const onSubmit = (data: VehicleSearchFormData) => {
    ...
    dispatch(setCurrentVehicle(payload));
  };
