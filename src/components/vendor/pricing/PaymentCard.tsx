...
const PRICING_PLANS = [
    ...
    { id: 'professional', name: 'Professional', price: { monthly: 63, yearly: 630 } },
    { id: 'business', name: 'Business', price: { monthly: 119, yearly: 1190 } },
    { id: 'enterprise', name: 'Enterprise', price: { monthly: 239, yearly: 2390 } },
];

const PaymentCard: React.FC<PaymentCardProps> = ({ onProceed }) => {
    const { billingCycle, selectedPlanId, servicesCount } = useAppSelector((state) => state.pricing);
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 w-3xl shadow-lg sticky top-6">
            ...
            <div className="space-y-2 mb-2">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <span className="text-sm font-semibold text-gray-900">{servicesCount} services</span>
                </div>
            </div>
            ...
            <button
                onClick={onProceed}
                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-3 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center gap-2 group"
            >
                Proceed to Payment
            ...
            <div className="mt-2 text-center space-y-1">
                <div className="flex items-center justify-center gap-1 text-xs text-gray-500">
                    ...
                    <span>Secure payment powered by Razorpay • 100% safe & encrypted</span>
                </div>
