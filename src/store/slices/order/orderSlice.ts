...
>("order/getOrderById", async (orderId, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.GET_ORDER_BY_ID.replace(
      ":id",
      orderId
    );
...
>("order/getServiceOrders", async (_, { rejectWithValue }) => {
  try {
    const response = await apiService.get(
      API_CONFIG.ENDPOINTS.GET_SERVICE_ORDERS
    );
    const data = response.data.data || response.data;
...
>("order/getSparesOrders", async (_, { rejectWithValue }) => {
  try {
    const response = await apiService.get(
      API_CONFIG.ENDPOINTS.GET_SPARES_ORDERS
    );
    const data = response.data.data || response.data;
    return data.orders || data;
  } catch (error: any) {
...
>("order/getInsuranceOrders", async (_, { rejectWithValue }) => {
  try {
    const response = await apiService.get(
      API_CONFIG.ENDPOINTS.GET_INSURANCE_ORDERS
    );
    const data = response.data.data || response.data;
    return data.orders || data;
  } catch (error: any) {
    return rejectWithValue(
      error?.response?.data?.message ||
        error.message ||
        "Failed to fetch insurance orders"
    );
  }
});
...
>("order/getTowingOrders", async (_, { rejectWithValue }) => {
  try {
    const response = await apiService.get(
      API_CONFIG.ENDPOINTS.GET_TOWING_ORDERS
    );
    const data = response.data.data || response.data;
    return data.orders || data;
  } catch (error: any) {
...
>("order/updateOrderStatus", async (payload, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.UPDATE_ORDER_STATUS.replace(
      ":id",
      payload.orderId
    );
...
>("order/cancelOrder", async (payload, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.CANCEL_ORDER.replace(
      ":id",
      payload.orderId
    );
...
>("order/reorderService", async (orderId, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.REORDER_SERVICE.replace(
      ":id",
      orderId
    );
    const response = await apiService.post(endpoint);
...
>("order/downloadInvoice", async (orderId, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.DOWNLOAD_INVOICE.replace(
      ":id",
      orderId
    );
    const response = await apiService.get(endpoint);
...
>("order/requestReturn", async (payload, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.REQUEST_RETURN.replace(
      ":id",
      payload.orderId
    );
    const response = await apiService.post(endpoint, {
...
>("order/fileClaim", async (payload, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.FILE_CLAIM.replace(
      ":id",
      payload.orderId
    );
...
>("order/addNominee", async (payload, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.ADD_NOMINEE.replace(
      ":id",
      payload.orderId
    );
    const response = await apiService.post(endpoint, {
...
>("order/modifyPolicy", async (payload, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.MODIFY_POLICY.replace(
      ":id",
      payload.orderId
    );
    const response = await apiService.post(endpoint, {
