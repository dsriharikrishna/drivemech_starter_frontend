...
import { resetBooking } from "@/store/slices/customer/towing-services/towingServiceSlice";
import CustomCard from "@/components/ui/CustomCard";
import Button from "@/components/ui/Button";
import { Star, Share2, Car } from "lucide-react";
...
export default function ReturnSubmitLayout() {
  ...
  const paymentMethod = useSelector(
    (s: RootState) => s.towingService.paymentMethod
  );
  ...
  const requestId =
    bookingId ?? `TOW${Math.floor(Math.random() * 900000) + 10000}`;
  ...
  const tripDetails = {
    ...
    vehicleMake:
      typeof formData.make === "string"
        ? formData.make
        : formData.make?.name || "Toyota",
    vehicleModel:
      typeof formData.model === "string"
        ? formData.model
        : formData.model?.name || "Camry",
  };
          ...
          <div className="mb-6">
            <div className="rounded-xl border border-blue-100 bg-blue-50 px-5 py-3">
              <div className="max-w-7xl mx-auto flex items-center gap-3 text-sm text-blue-800">
                ...
                <div>
                  A driver will be assigned shortly. You'll receive a call and
                  can track the tow truck in real-time.
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="text-right">
                      <span className="inline-block px-3 py-1 text-xs bg-green-50 text-green-700 rounded-full">
                        On the way
                      </span>
            ...
            <CustomCard className="p-5 rounded-2xl border">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900">
                    {tripDetails.vehicleMake} {tripDetails.vehicleModel}
                  </p>
                  <p className="text-xs text-gray-500">
                    Reg: {tripDetails.vehicleReg} • SUV
                  </p>
                </div>
              </div>
            </CustomCard>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-blue-700 mt-1">
                    Share your live location with family and friends for added
                    safety
                  </p>
                </div>
