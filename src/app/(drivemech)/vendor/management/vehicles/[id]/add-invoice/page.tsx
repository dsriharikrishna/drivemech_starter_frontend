            ...
            <div className="w-full bg-white min-h-screen">
                <div className="border border-gray-200 rounded-2xl overflow-hidden">
                    ...
                    <div className="bg-[#EEF3FB] px-5 py-3.5 flex items-center justify-between border-b border-gray-200">
                        ...
                        <div className="flex items-center gap-2">
                            <Button type="button" variant="primary-blue" size="sm" startIcon={<Plus size={14} />} onClick={() => append({ product: "", description: "", quantity: 0, unitPrice: 0 })}>Add</Button>
                            <button type="button" className="h-8 w-8 flex items-center justify-center bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors">
                                <ChevronDown size={14} />
                            </button>
                        </div>
                    </div>
                    ...
                    <form onSubmit={methods.handleSubmit(onSubmit)}>
                        <div className="p-5 space-y-5">
                            ...
                            <div>
                                ...
                                />
                                <div className="rounded-b-lg px-4 py-3 flex items-start justify-between gap-4 bg-white">
                                    <Button type="button" variant="primary-blue" size="sm" startIcon={<Plus size={13} />} onClick={() => append({ product: "", description: "", quantity: 0, unitPrice: 0 })}>Add</Button>
                                    <div className="min-w-[260px] space-y-1.5 text-sm border border-gray-200 rounded-lg p-2">
                                        <div className="flex items-center justify-between text-gray-600">
                                            <span>Sub Total</span><span className="font-medium text-gray-800">${subTotal.toFixed(2)}</span>
                                        </div>
                                        <div className="flex items-center justify-between text-gray-600">
                                            <span>Freight</span><span className="font-medium text-gray-800">$ {freight.toFixed(2)}</span>
                                        </div>
                                        <div className="flex items-center justify-between text-gray-600">
                                            <span>Sales Tax (10%)</span><span className="font-medium text-gray-800">$ {salesTax.toFixed(2)}</span>
                                        </div>
