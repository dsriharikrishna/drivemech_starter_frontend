 ...
 */
export const vendorMpinSchema = z.object({
    mpin: z
        .string()
...
export type VendorOtpVerificationData = z.infer<typeof vendorOtpVerificationSchema>;
export type VendorMpinData = z.infer<typeof vendorMpinSchema>;
export type VendorCompleteRegistrationData = z.infer<typeof vendorCompleteRegistrationSchema>;
