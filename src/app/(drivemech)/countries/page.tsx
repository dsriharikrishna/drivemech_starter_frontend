              ...
              {cities.map((city) => (
                ...
                >
                  ...
                  <div className="mt-3 pt-3 border-t">
                    <p className="text-xs text-gray-500">
                      {city.states.length}{" "}
                      {city.states.length === 1 ? "State" : "States"}
                    </p>
                  </div>
                </div>
              ))}
                    ...
                    <li key={pageNum === "..." ? `ellipsis-${idx}` : pageNum}>
                      {pageNum === "..." ? (
                        ...
                        <button
                          ...
                          className={`flex items-center justify-center box-border border border-gray-300 font-medium text-sm w-10 h-10 focus:outline-none ${
                            page === pageNum
