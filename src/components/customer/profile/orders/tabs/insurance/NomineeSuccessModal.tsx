  ...
  return (
    <div className="bg-white w-full sm:w-2xl md:w-3xl rounded-2xl shadow-xl overflow-hidden animate-slideUp">
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div className="border border-border rounded-xl p-5 bg-orange-50">
        ...
        {/* MINOR NOTICE */}
        {nominee.isMinor && (
          <div className="border border-border rounded-xl p-4 bg-yellow-50 text-sm">
        ...
        {/* WHAT'S NEXT */}
        <div className="border border-border rounded-xl p-5 bg-green-50 text-gray-700 text-sm">
