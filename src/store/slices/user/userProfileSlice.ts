...
>("userProfile/getAddressById", async (addressId, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.GET_ADDRESS_BY_ID.replace(
      ":id",
      addressId
    );
...
>("userProfile/updateAddress", async (payload, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.UPDATE_ADDRESS.replace(
      ":id",
      payload.id
    );
...
>("userProfile/deleteAddress", async (addressId, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.DELETE_ADDRESS.replace(
      ":id",
      addressId
    );
...
>("userProfile/setDefaultAddress", async (addressId, { rejectWithValue }) => {
  try {
    const endpoint = API_CONFIG.ENDPOINTS.SET_DEFAULT_ADDRESS.replace(
      ":id",
      addressId
    );
...
>("userProfile/updatePreferences", async (payload, { rejectWithValue }) => {
  try {
    const response = await apiService.put(
      API_CONFIG.ENDPOINTS.UPDATE_PREFERENCES,
      payload
    );
    return response.data.data || response.data;
  } catch (error: any) {
...
>("userProfile/getNotificationSettings", async (_, { rejectWithValue }) => {
  try {
    const response = await apiService.get(
      API_CONFIG.ENDPOINTS.GET_NOTIFICATION_SETTINGS
    );
    return response.data.data || response.data;
  } catch (error: any) {
    return rejectWithValue(
...
export const updateNotificationSettings = createAsyncThunk<
  ...
  { rejectValue: string }
>(
  "userProfile/updateNotificationSettings",
  async (payload, { rejectWithValue }) => {
    try {
      const response = await apiService.put(
        API_CONFIG.ENDPOINTS.UPDATE_NOTIFICATION_SETTINGS,
        payload
      );
      return response.data.data || response.data;
    } catch (error: any) {
