...
export const services: Service[] = [
    ...
    nestedServices: [
      {
        id: "ac-regas",
        name: "AC Regassing",
        description: "Recharge your AC system",
        price: 120,
      },
      {
        id: "ac-compressor",
  ...
  },
  {
    ...
    nestedServices: [
      ...
      {
        id: "ignition-coil",
        name: "Ignition Coil Service",
        description: "Service ignition coils",
        price: 250,
      },
    ],
  },
  {
    ...
    nestedServices: [
      ...
      {
        id: "brake-discs",
        name: "Brake Disc Machining",
        description: "Machine brake discs",
        price: 150,
      },
      {
        id: "brake-fluid",
        name: "Brake Fluid Flush",
        description: "Flush brake fluid system",
        price: 120,
      },
    ],
  },
    ...
    nestedServices: [
      {
        ...
        description: "Full transmission service",
        price: 350,
      },
      {
        id: "differential-service",
        name: "Differential Service",
        description: "Differential oil change",
        price: 200,
      },
    ],
  },
  ...
  },
  {
    ...
    nestedServices: [
      ...
      },
      {
        ...
        description: "Timing chain inspection",
        price: 300,
      },
    ],
  },
  ...
  },
  {
    ...
    nestedServices: [
      {
        id: "full-tint",
        name: "Full Car Tinting",
        description: "Tint all windows",
        price: 350,
      },
      {
        id: "front-tint",
        name: "Front Windows Only",
        description: "Tint front windows",
        price: 200,
      },
    ],
  },
    ...
    nestedServices: [
      {
        ...
        description: "Replace windshield",
        price: 450,
      },
      {
        id: "window-repair",
        name: "Chip Repair",
        description: "Repair glass chips",
        price: 120,
      },
    ],
  },
    ...
    nestedServices: [
      {
        ...
        description: "Full clutch replacement",
        price: 850,
      },
      {
        id: "clutch-cable",
        name: "Clutch Cable Adjustment",
        description: "Adjust clutch cable",
        price: 80,
      },
    ],
  },
  {
    ...
    nestedServices: [
      ...
      },
      {
        ...
        description: "Balance all wheels",
        price: 80,
      },
    ],
  },
