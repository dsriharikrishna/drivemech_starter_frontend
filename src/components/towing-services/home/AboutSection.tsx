    ...
    <section className="w-full py-10 bg-white">
      <div className="max-w-5xl mx-auto text-center px-4">
        ...
        <p className="mt-4 text-gray-600 text-sm leading-relaxed">
          ...
          <br />
          <br />
          With a fleet of modern tow trucks and trained professionals, we're
          equipped to handle everything from small cars to heavy vehicles. We
          understand that breakdowns are stressful, which is why we are
          committed to making your towing process as smooth as possible.
        </p>
      </div>
    </section>
  );
