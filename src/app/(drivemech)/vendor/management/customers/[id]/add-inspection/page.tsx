...
import AddInspectionForm from "@/components/vendor/management/customers/forms/AddInspectionForm";

const AddCustomerInspectionPage = ({
    params,
}: {
...
export default AddCustomerInspectionPage;
