...
export const createMpinSchema = z
  .object({
    mpin: z
      ...
      .refine((val) => !WEAK_MPIN_PATTERNS.includes(val), {
        message:
          "Please choose a more secure MPIN. Avoid common patterns like 1234 or 1111",
      })
      .refine(
        (val) => {
 ...
 */
export const verifyMpinSchema = z
  .object({
 ...
 */
export const forgotMpinSchema = z
  .object({
