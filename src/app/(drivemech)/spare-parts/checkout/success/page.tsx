...
const OrderSuccessPage = () => {
    ...
    const { cartItems, addressData } = useAppSelector(state => state.sparePartsCheckout);
        ...
        <div className="min-h-screen bg-white py-12">
            <div className="container mx-auto px-4 max-w-5xl">
                ...
                <div className="flex justify-center mb-8">
                    <div className="relative">
                        ...
                        <svg width="120" height="120" viewBox="0 0 120 120" fill="none">
                            {/* Outer Gear */}
                            <circle cx="40" cy="40" r="28" fill="none" stroke="#1F2937" strokeWidth="3" />
                            ...
                            {/* Inner Gear */}
                            <circle cx="75" cy="75" r="24" fill="none" stroke="#1F2937" strokeWidth="3" />
                            ...
                            <path d="M69 75 L73 79 L81 71" stroke="white" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                </div>
                ...
                <p className="text-center text-gray-600 mb-10">
                    Your Order ID is : <span className="text-blue-600 font-semibold">{orderId}</span>
                </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white rounded-lg border border-gray-200">
                            {cartItems.map((item, index) => (
                                <div
                                    key={item.id}
                                    className={`flex items-center justify-between p-4 ${index !== cartItems.length - 1 ? 'border-b border-gray-200' : ''
                                        }`}
                                >
                                    ...
                                    <p className="font-semibold text-gray-900 text-lg ml-4">$ {item.price.toFixed(2)}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-5">
                            <h3 className="font-semibold text-gray-900 mb-4 text-base">Estimate Deliver</h3>
                            <div className="flex items-start gap-3">
                                <div className="w-12 h-12 bg-gray-50 rounded-lg flex items-center justify-center flex-shrink-0">
                                    <Calendar className="w-6 h-6 text-gray-600" />
                                </div>
                                <div>
                                    <p className="font-semibold text-gray-900 text-sm mb-1">{formattedDate}</p>
                                    <button
                        ...
                        {/* Delivery Address */}
                        <div className="bg-white rounded-lg border border-gray-200 p-5">
                            <h3 className="font-semibold text-gray-900 mb-4 text-base">Delivery Address</h3>
                            {addressData && (
