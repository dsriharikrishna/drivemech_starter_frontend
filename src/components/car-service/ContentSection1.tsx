...
export default function ContentSection1() {
  return (
    <section className="py-10 sm:py-14 md:py-20">
      <div className="max-w-[1215px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10 bg-[#EDEDED] rounded-2xl">
        <div
        ...
        >
          ...
          <div className="flex-1 w-full space-y-4 sm:space-y-6 py-5 text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start">
              <button
                className="font-manrope bg-green-500 px-5 py-3 rounded-lg hover:bg-green-600 font-bold text-white transition-colors flex items-center gap-2"
                style={{ fontSize: "16px" }}
              >
