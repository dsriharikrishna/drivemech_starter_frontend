...
const defaultBenefits: Benefit[] = [
    {
        ...
        description: 'Original equipment manufacturer quality parts for lasting performance',
...
export default function WhyChooseUs({ benefits = defaultBenefits }: WhyChooseUsProps) {
    return (
