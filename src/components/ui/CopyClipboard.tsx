...
const CopyClipboard: React.FC<CopyClipboardProps> = ({ value }) => {
  ...
  return (
    <div className="w-full max-w-[16rem] relative">
      ...
      {/* Tooltip */}
      <div
        className={`absolute z-10 inline-block px-3 py-2 text-sm font-medium text-white bg-gray-800 rounded-lg shadow-xs top-full mt-1 transition-opacity duration-300 ${
