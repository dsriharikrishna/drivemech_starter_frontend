...
import { supplierInvoiceFormSchema, SupplierInvoiceFormValues } from "@/schemas/vendor/supplier.schema";
import CommonTextInput from "@/components/forms/CommonTextInput";
import CommonTextArea from "@/components/forms/CommonTextArea";
import Button from "@/components/ui/Button";
import { FileText } from "lucide-react";

const AddSupplierInvoicePage = ({
    params,
}: {
    ...
    const onSubmit = (data: SupplierInvoiceFormValues) => {
        console.log("Add supplier invoice", data);
        router.back();
    };
                    ...
                    <div className="p-0 flex flex-col gap-1 border border-gray-200 rounded-xl">
                        ...
                        <div className="bg-blue-50 border border-gray-200 rounded-xl px-4 py-3 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-semibold text-gray-800">Add Invoice</span>
                            </div>
                            <div className="flex items-center gap-1 text-sm text-gray-500">
                                ...
                                <span className="text-blue-600 font-medium">Add Invoice</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={methods.handleSubmit(onSubmit)} className="space-y-6">
                            <div className="bg-white rounded-lg p-6 border border-gray-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                    <CommonTextInput name="reference" label="Reference *" placeholder="REF-001" />
                                    <CommonTextInput name="postDate" label="Post Date *" placeholder="DD/MM/YY" />
                                    <CommonTextInput name="invoiceType" label="Invoice Type *" placeholder="Standard" />
                                    <CommonTextInput name="paymentTerms" label="Payment Terms *" placeholder="Net 30" />
...
export default AddSupplierInvoicePage;
