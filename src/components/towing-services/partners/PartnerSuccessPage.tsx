        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 items-start">
          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col items-center text-center gap-6 mb-20">
              <img
                src="/images/towing-services/partners/RightCheck.png"
                alt="Success"
                className="w-20 h-20"
              />
              ...
              <p className="text-gray-600 text-sm max-w-xl">
                ...
                We’re excited to review your application and help grow your
                business.
              </p>

              <CustomCard className="border border-orange-200 bg-orange-50 rounded-xl p-6 text-center max-w-sm">
                <p className="text-gray-heading text-sm font-semibold">
              ...
              <div className="flex flex-col gap-0">
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <p className="font-semibold text-sm text-gray-heading">
                      Application Review
                    </p>
            ...
            <CustomCard className="p-5 border  rounded-2xl">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex justify-between items-center border border-border rounded-xl p-5 bg-white hover:bg-gray-50 cursor-pointer">
                  <div>
                    <p className="font-semibold text-gray-heading text-sm">
                      Partner Guide
                    </p>
                    <p className="text-xs text-gray-500">
          ...
          <div className="flex flex-col gap-8">
            ...
            {/* Need Help */}
            <CustomCard className="p-8 border rounded-2xl">
              <p className="font-semibold text-gray-heading text-[16px] mb-5">
                Need Help?
              </p>
