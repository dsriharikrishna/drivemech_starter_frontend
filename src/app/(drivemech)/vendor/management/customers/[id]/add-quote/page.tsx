...
import { ReceiptItemIcon } from "@/components/icons/ManagementModuleIcons";
import AddQuoteForm from "@/components/vendor/management/customers/forms/AddQuoteForm";

const AddCustomerQuotePage = ({
    params,
}: {
                ...
                <div className="p-0 flex flex-col gap-1 border border-gray-200 rounded-xl">
                    ...
                    <div className="bg-blue-50 border border-gray-200 rounded-xl px-4 py-3 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <ReceiptItemIcon size={18} className="text-gray-700" />
                            <span className="text-sm font-semibold text-gray-800">Add Quote</span>
                        </div>
                        <div className="flex items-center gap-1 text-sm text-gray-500">
                            ...
                            <span className="text-blue-600 font-medium">Add Quote</span>
                        </div>
                    </div>
...
export default AddCustomerQuotePage;
