...
export const SparePartsHero = () => {
    ...
    const onSubmit = (data: SparePartsSearchFormData) => {
        console.log('Finding spares for:', data);
        // Handle form submission - navigate to spare parts search results
    };
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <FormProvider {...methods}>
                            <form onSubmit={methods.handleSubmit(onSubmit)} className="bg-white rounded-xl shadow-md p-6">
