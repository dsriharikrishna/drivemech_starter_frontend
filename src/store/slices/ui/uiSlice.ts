...
import { UIState, ModalName, Toast, Modal, Theme } from "@/types/ui/uiTypes";
...
const uiSlice = createSlice({
  ...
  reducers: {
    ...
    openModal: (
      state,
      action: PayloadAction<{ name: ModalName; data?: any }>
    ) => {
    ...
    setScreenSize: (
      ...
      state.isTablet =
        action.payload.width >= 768 && action.payload.width < 1024;
