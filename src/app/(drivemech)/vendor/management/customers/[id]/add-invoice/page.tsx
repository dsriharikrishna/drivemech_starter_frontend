...
import AddInvoiceForm from "@/components/vendor/management/customers/forms/AddInvoiceForm";

const AddCustomerInvoicePage = ({
    params,
}: {
                ...
                <div className="p-0 flex flex-col gap-1 border border-gray-200 rounded-xl">
                    ...
                    <div className="bg-blue-50 border border-gray-200 rounded-xl px-4 py-3 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <DocumentTextIcon size={18} className="text-gray-700" />
...
export default AddCustomerInvoicePage;
