...
const addPartOrderSchema = z.object({
...
type AddPartOrderFormValues = z.infer<typeof addPartOrderSchema>;
...
const AddPartOrderPage = ({
    ...
    const methods = useForm<AddPartOrderFormValues>({
        resolver: zodResolver(addPartOrderSchema),
    });

    const { control, handleSubmit } = methods;

    const onSubmit = (data: AddPartOrderFormValues) => {
        console.log("Add part order", data);
        router.back();
    };
                    ...
                    <div className="p-0 flex flex-col gap-1 border border-gray-200 rounded-xl">
                        ...
                        <div className="bg-blue-50 border border-gray-200 rounded-xl px-4 py-3 flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-1 text-sm text-gray-500">
                                <button
                                    onClick={() => router.push(`/vendor/inventory/inventory/${id}`)}
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            <div className="bg-white rounded-lg p-6 border border-gray-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                    ...
                                    />
                                    <CommonNumberInput name="freight" label="Freight" placeholder="0.00" min={0} step={0.01} />
...
export default AddPartOrderPage;
