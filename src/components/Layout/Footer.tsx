      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <SmoothLandingContainer staggerDelay={0.1}>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            {/* ABOUT US */}
            <SmoothLandingItem variant="slide-up" distance={30}>
              <div>
            ...
            <SmoothLandingItem variant="slide-up" distance={30}>
              <div>
                ...
                <ul className="space-y-2 text-gray-400 text-sm">
                  ...
                  <li>
                    <Link
                      href="/services/service-inspection"
                      className="hover:text-white transition-colors"
                    >
                      Service/PV Inspection
                    </Link>
                  </li>
                  <li>
                    <Link
        ...
        <SmoothLandingBox variant="fade" delay={0.3} duration={0.8}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Your trusted partner for all vehicle servicing needs. Fast,
              ...
              <div>
                ...
                <div className="flex gap-3 mb-4">
                  <a
                    href="https://instagram.com/drivemech"
                    target="_blank"
                  ...
                  <a
                    href="https://facebook.com/drivemech"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-white transition-colors"
                  >
                  ...
                  <a
                    href="https://twitter.com/drivemech"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gray-400 hover:text-white transition-colors"
                  >
        ...
        {/* Bottom Copyright */}
        <SmoothLandingBox variant="fade" delay={0.4} duration={0.6}>
          <div className="border-t border-gray-700 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm gap-4">
              ...
              <p className="mt-2 md:mt-0">
                Made with <span className="text-red-500">❤️</span> for vehicle
                owners and garages
              </p>
