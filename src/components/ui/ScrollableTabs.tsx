...
export default function ScrollableTabs({
    ...
    return (
        <div
            className={`relative bg-white flex items-center gap-2 w-full rounded-2xl max-w-4xl mx-auto ${className}`}
            role="tablist"
        ...
        >
            ...
            <div
                ...
                className={`
                    flex-1 flex items-center gap-2 sm:gap-3 md:gap-4
                    ...
                    return (
                        <button
                            ...
                            className={`
                                ...
                                ${isCompact
                                    ? 'gap-0.5 sm:gap-1 px-2 sm:px-3 py-1 sm:py-1.5'
                                    : 'gap-1 sm:gap-1.5 md:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2'
                                }
